    ...
    <section className="relative h-[100vh] min-h-[600px] max-h-[800px] flex items-center overflow-hidden font-['Inter']" id="hero">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 flex justify-between items-center mt-[-60px]">
        ...
        <div className="max-w-2xl text-white">
          ...
          <h1 className="text-[56px] md:text-[72px] font-bold leading-[1.1] mb-2 tracking-tight">
            {language === 'en' ? 'Join CEBC' : '加入CEBC'}
          </h1>
          <h2 className="text-[48px] md:text-[64px] font-bold leading-[1.1] mb-5 tracking-tight">
            {language === 'en' ? 'Connect China and Eurasia' : '连接中国与欧亚'}
          </h2>
          
          {language === 'cn' && (
            <p className="text-[20px] font-medium mb-8 text-white">
              Join CEBC, Connect China and Eurasia
            </p>
          )}
          {language === 'en' && <div className="h-6"></div>}
          
          <p className="text-[14px] md:text-[15px] mb-12 text-white/90 leading-[1.8] max-w-[540px]">
            {language === 'en' 
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-5">
            <a href="#pricing" className="bg-[#F1A424] text-[#0A1B3F] text-[14px] font-bold px-8 py-3.5 rounded-[2px] hover:bg-[#ffb53a] transition-colors flex items-center justify-center min-w-[200px]">
              {language === 'en' ? 'Become a Corporate Member' : '成为企业会员'} <span className="ml-2">→</span>
            </a>
            <a href="#benefits" className="border border-white/50 text-white text-[14px] font-medium px-8 py-3.5 rounded-[2px] hover:bg-white/10 transition-colors flex items-center justify-center min-w-[200px] backdrop-blur-sm">
        ...
        <div className="hidden lg:block text-right border-l-[2px] border-[#F1A424] pl-5">
          <h3 className="text-white font-medium text-[20px] tracking-[0.1em] mb-1">
            {language === 'en' ? 'FROM CHINA' : '从中国走向欧亚'}
          </h3>
          <h3 className="text-white font-medium text-[20px] tracking-[0.1em] mb-4">
            {language === 'en' ? 'TO A WIDER EURASIA' : '共创更广阔的未来'}
          </h3>
          {language === 'cn' && (
            <>
              <p className="text-white/70 text-[10px] uppercase tracking-[0.15em] leading-[1.5]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="flex items-center space-x-4 group">
              ...
              <div>
                ...
                {language === 'en' ? (
                  <div className="text-gray-400 text-[10px] mt-0.5">Members & Partners</div>
                ) : (
                  <div className="text-gray-400 text-[10px] mt-0.5 leading-[1.3]">会员与合作伙伴<br/>Members & Partners</div>
                )}
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 border-l border-white/20 pl-8 group">
              ...
              <div>
                ...
                {language === 'en' ? (
                  <div className="text-gray-400 text-[10px] mt-0.5 leading-[1.3]">Central Asian Countries<br/>(and wider Eurasia)</div>
                ) : (
                  <div className="text-gray-400 text-[10px] mt-0.5 leading-[1.3]">中亚国家 (及更广泛的欧亚地区)<br/>Central Asian Countries</div>
                )}
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 border-l border-white/20 pl-8 group">
              ...
              <div>
                <div className="text-white font-bold text-[18px]">{language === 'en' ? 'Abundant' : '丰富的'}</div>
                {language === 'en' ? (
                  <div className="text-gray-400 text-[10px] mt-0.5 leading-[1.3]">Business Opportunities</div>
                ) : (
                  <div className="text-gray-400 text-[10px] mt-0.5 leading-[1.3]">商业机会<br/>Business Opportunities</div>
                )}
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 border-l border-white/20 pl-8 group">
              ...
              <div>
                <div className="text-white font-bold text-[18px]">{language === 'en' ? 'Strong' : '强大的'}</div>
                {language === 'en' ? (
                  <div className="text-gray-400 text-[10px] mt-0.5 leading-[1.3]">Expert Network</div>
                ) : (
                  <div className="text-gray-400 text-[10px] mt-0.5 leading-[1.3]">专家网络<br/>Expert Network</div>
                )}
              </div>
            </div>
          </div>
